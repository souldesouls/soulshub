                                                ...
                                                <tr>
                                                    <td width="auto" align="center" valign="middle" height="28"
                                                        ...
                                                        <span style="color:  <?= Yii::$app->view->theme->variable('text-color-highlight', '#555') ?>; font-weight: 300;">
                                                            <?= Yii::t('UserModule.base', '%userId%, welcome to %appName%!', ['%appName%' => '<strong>' . Html::encode(Yii::$app->name) . '</strong>', '%userId%' => '<strong>' . Html::encode($userId) . '</strong>']); ?>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>

...
return [
    ...
    '<strong>User</strong> modules' => '<strong>Användar</strong> moduler',
    ...
    'Enable' => 'Aktivera',
    'Enhance your profile with modules.' => 'Förbättra din profil med moduler.',
    ...
    'You are currently the owner of following spaces:' => 'Du är för närvarande ägare av följande nätverk:',
    ...
    'You must transfer ownership or delete these spaces before you can delete your account.' => 'Du måste överföra äganderätten eller ta bort dessa nätverk innan du kan ta bort ditt konto.',
